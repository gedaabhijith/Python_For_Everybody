...
#to http://www.py4e.com/code3/json2.py. The program will prompt for 
#a URL, read the JSON data from that URL using urllib and then parse 
#and extract the comment counts from the JSON data, compute the sum 
...
#Sum=2553)
#Actual data: http://py4e-data.dr-chuck.net/comments_307981.json (
#Sum ends with 82)
...
#  ]
#}
#The closest sample code that shows how to parse JSON and extract a 
#list is json2.py. You might also want to look at geoxml.py to see 
#how to prompt for a URL and retrieve data from a URL.

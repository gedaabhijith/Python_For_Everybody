...
#and numbers. You will extract all the numbers in the file and 
...
#Actual data: http://py4e-data.dr-chuck.net/regex_sum_307976.txt (
#There are 90 values and the sum ends with 437)
#These links open in a new window. Make sure to save the file into 
#the same folder as you will be writing your Python program. Note: 
#Each student will have a distinct data file for the assignment - so 
#only use your own data file for analysis.
#Data Format
#The file contains much of the text from the introduction of the 
#textbook except that random numbers are inserted throughout the 
#text. Here is a sample of the output you might see:
...
#anywhere in the line. There can be any number of numbers in each 
#line (including none).
#Handling The Data
...
if len(name) < 1 : name = "regex_sum_307976.txt"

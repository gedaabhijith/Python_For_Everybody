...
#Library.xml file to be used for this assignment. You can export 
#your own tracks from iTunes and create a database, but for the 
#database that you turn in for this assignment, only use the 
